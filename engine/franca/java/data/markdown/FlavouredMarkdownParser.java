...
public class FlavouredMarkdownParser extends MarkdownParser {
  ...
  public Block appendCharsBlock(Block parentBlock, String charsType, String chars, JsonObject styleJsonObject) {
    if (chars.startsWith("/[")) {
      ...
      return super.appendCharsBlock(parentBlock, bufferedString.getString(), "chars-ipa", styleJsonObject);
    }
    return super.appendCharsBlock(parentBlock, charsType, chars, styleJsonObject);
  }
